...
export const sampleVideos: SampleVideo[] = [
  ...
  },
  {
    ...
    duration: "5-15 sec",
    quality: "1080p controlled tests",
    ...
    features: ["Multiple hooks", "Caption variants", "Controlled 1080p tests", "Social publishing prep"],
  ...
  {
    id: "premium-1080p-smoke-test",
    title: "1080p provider smoke test",
    category: "Premium test video",
    format: "Controlled premium test clip",
    duration: "10-15 sec",
    quality: "1080p",
    credits: "Pro / Business",
    description: "A controlled 1080p smoke-test workflow for validating provider routing without dropping below Crelavo's premium quality floor.",
    features: ["Provider smoke test", "1080p", "Hook validation", "Premium quality floor"],
    href: "/dashboard/assistant-workspace?idea=1080p%20provider%20smoke%20test%20sample"
  },
  {
    id: "premium-1080p-ad",
