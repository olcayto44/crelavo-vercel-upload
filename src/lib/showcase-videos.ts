...
export const showcaseVideos: ShowcaseVideo[] = [
  ...
  { id: "crelavo-luxury-perfume-bottle-mirror-corridor", title: "Crelavo Luxury Perfume in a Mirror Corridor", kicker: "Luxury fragrance film", description: "A premium Crelavo fragrance bottle revealed through a futuristic mirrored corridor and cinematic light waves.", videoUrl: "/showcase/uploads/crelavo-luxury-perfume-mirror-corridor.mp4", duration: "PT5S", orientation: "landscape", uploadDate: "2026-09-26T01:00:00.000Z", details: ["Futuristic mirrored product reveal.", "Luxury fragrance lighting and reflective staging."], bestFor: ["Perfume advertising", "Luxury product film", "Cinematic ecommerce"] },
  { id: "crelavo-campaign-idea-workflow-launch", title: "Transform Ideas into Campaigns with Crelavo AI", kicker: "AI campaign workflow", description: "A visual tour of turning one campaign idea into web, mobile, social and video assets with Crelavo AI.", videoUrl: "/showcase/uploads/crelavo-campaign-workflow-launch.mp4", duration: "PT15S", orientation: "portrait", uploadDate: "2026-09-26T01:01:00.000Z", details: ["Campaign idea transformed into multiple digital outputs.", "AI workflow, editing and analytics interface presentation."], bestFor: ["AI campaigns", "Marketing workflow", "Product demo"] },
  { id: "luxury-black-leather-duffle-bag-nova-form", title: "Nova Form Luxury Black Leather Duffle Bag", kicker: "Fashion accessory campaign", description: "A premium black leather duffle bag shown through studio detail shots and a cinematic city carry sequence.", videoUrl: "/showcase/uploads/nova-form-leather-duffle-bag.mp4", duration: "PT15S", orientation: "portrait", uploadDate: "2026-09-26T01:02:00.000Z", details: ["Leather, stitching and zipper detail close-ups.", "Studio product staging and outdoor fashion use."], bestFor: ["Bag advertising", "Fashion ecommerce", "Luxury accessories"] },
  { id: "elegant-woman-green-dress-luxury-perfume", title: "Elegant Woman Presenting Luxury Perfume", kicker: "Beauty fragrance campaign", description: "An elegant fragrance advertisement featuring a woman presenting and applying a luxury perfume in a refined interior.", videoUrl: "/showcase/uploads/woman-green-dress-luxury-perfume.mp4", duration: "PT15S", orientation: "portrait", uploadDate: "2026-09-26T01:03:00.000Z", details: ["Premium perfume bottle hero shot.", "Model-led application moment and beauty styling."], bestFor: ["Perfume campaign", "Beauty advertising", "Luxury social video"] },
  { id: "crelavo-ai-ad-generator-from-product-link", title: "Convert Product Links to AI Video Ads", kicker: "Crelavo product demo", description: "A presenter demonstrates how Crelavo turns a product link into an AI video advertising campaign and digital content.", videoUrl: "/showcase/uploads/crelavo-product-link-ai-video-ad.mp4", duration: "PT15S", orientation: "portrait", uploadDate: "2026-09-26T01:04:00.000Z", details: ["Product-link-to-ad workflow explained by a presenter.", "Dynamic AI video and avatar campaign examples."], bestFor: ["Product link ads", "AI video generator", "Ecommerce campaigns"] },
  { id: "crelavo-fast-ai-ad-creator", title: "Fast AI Video Ad Creation with Crelavo", kicker: "AI production workflow", description: "A time-sensitive campaign is completed rapidly with Crelavo's AI ad creation workflow.", videoUrl: "/showcase/uploads/crelavo-fast-ai-ad-creator.mp4", duration: "PT15S", orientation: "portrait", uploadDate: "2026-09-26T01:05:00.000Z", details: ["Deadline-driven campaign editing scenario.", "Crelavo workflow resolves a production bottleneck."], bestFor: ["AI ad creator", "Fast production", "Marketing teams"] },
  { id: "luxury-crystal-perfume-bottle-cinematic-zoom", title: "Cinematic Luxury Crystal Perfume Bottle", kicker: "Premium product close-up", description: "A faceted crystal perfume bottle receives a dramatic cinematic close-up with atmospheric particles and reflective detail.", videoUrl: "/showcase/uploads/luxury-crystal-perfume-cinematic.mp4", duration: "PT8S", orientation: "landscape", uploadDate: "2026-09-26T01:06:00.000Z", details: ["Slow cinematic product push-in.", "Crystal geometry and liquid reflections emphasized."], bestFor: ["Luxury fragrance", "Product close-up", "Cinematic advertising"] },
  { id: "crelavo-ai-workspace-creative-woman-city", title: "Crelavo AI Creative Workspace in the City", kicker: "Creator platform promo", description: "A creator introduces Crelavo's video, campaign and website capabilities from a bright urban setting.", videoUrl: "/showcase/uploads/crelavo-ai-woman-city.mp4", duration: "PT14S", orientation: "landscape", uploadDate: "2026-09-26T01:07:00.000Z", details: ["Creator-led platform introduction.", "Crelavo capabilities presented with visual feature icons."], bestFor: ["Creator marketing", "AI platform promo", "Brand awareness"] },
  { id: "inspiring-youth-soccer-dream-journey", title: "Inspiring Youth Soccer Dream Journey", kicker: "Sports transformation film", description: "A barefoot boy runs through a coastal village before transforming into a confident young football player in an inspirational cinematic sports story.", videoUrl: "/showcase/uploads/youth-soccer-dream-journey.mp4", duration: "PT5S", orientation: "landscape", uploadDate: "2026-09-26T02:00:00.000Z", details: ["Village street run transforms into an athlete reveal.", "Aspirational youth sports storytelling at golden hour."], bestFor: ["Football campaign", "Youth sports", "Inspirational advertising"] },
  { id: "crelavo-ecommerce-ai-video-explainer", title: "Create E-Commerce Videos with Crelavo AI", kicker: "AI ecommerce explainer", description: "A presenter explains how Crelavo converts Shopify and Amazon product links into localized marketing videos for global e-commerce campaigns.", videoUrl: "/showcase/uploads/crelavo-ecommerce-ai-video-explainer.mp4", duration: "PT37S", orientation: "landscape", uploadDate: "2026-09-26T02:01:00.000Z", details: ["Presenter-led product-link-to-video workflow.", "TikTok Shop, Amazon and Shopify campaign integrations."], bestFor: ["E-commerce marketing", "SaaS explainer", "AI video creation"] },
  { id: "cozy-couples-conversation-card-game", title: "Cozy Couples Conversation Card Game Night", kicker: "Relationship game campaign", description: "A young couple shares cards, smiles and laughter during an intimate conversation game night at home.", videoUrl: "/showcase/uploads/couples-conversation-card-game.mp4", duration: "PT8S", orientation: "portrait", uploadDate: "2026-09-26T02:02:00.000Z", details: ["Warm lifestyle demonstration with two players.", "Conversation prompts create a playful connection moment."], bestFor: ["Couples gifts", "Card game advertising", "Date night products"] }
];
