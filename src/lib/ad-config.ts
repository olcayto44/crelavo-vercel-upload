...
export const defaultAdSlots: AdSlotConfig[] = [
  ...
  { id: "splash", name: "$79 / 12,000 credits splash campaign", placement: "Home page visitor splash popup", size: "640x360 desktop, 320x250 mobile", width: 640, height: 360, status: "active", code: "{\"eyebrow\":\"Limited-time launch offer\",\"title\":\"12,000 credits are live\",\"body\":\"Start your 24-hour preview for just $10. The Business plan now gives 12,000 credits instead of the usual 9,000.\",\"cta\":\"Start preview for $10\",\"href\":\"/dashboard/payment?package=business&billing=monthly&campaign=business-12000\",\"durationDays\":7,\"storageKey\":\"crelavo-business-12000-countdown\",\"countdownLabel\":\"Offer ends in\"}", notes: "Centered splash popup with upper-right close button. Same browser sees it up to 3 times per day. Countdown starts from the visitor's first view when no fixed endsAt is set." },
