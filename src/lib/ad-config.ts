...
export const defaultAdSlots: AdSlotConfig[] = [
  ...
  { id: "splash", name: "Pro 24-hour free trial splash campaign", placement: "Home page visitor splash popup", size: "640x360 desktop, 320x250 mobile", width: 640, height: 360, status: "active", code: "{\"eyebrow\":\"PRO 24-HOUR FREE TRIAL\",\"title\":\"Try Crelavo Pro for $0 today\",\"body\":\"Most AI platforms ask you to pay before you trust the workflow. Claim the first 24 hours free, then continue with the Pro plan at $9.99/month unless cancelled through Whop. Pro includes 2,500 AI production credits every month.\",\"cta\":\"CLAIM THE 24H FREE TRIAL\",\"href\":\"https://whop.com/checkout/plan_ujLQgM3kEg0dg\",\"durationDays\":7,\"storageKey\":\"crelavo-pro-2500-free-trial-countdown\",\"countdownLabel\":\"Trial offer ends in\",\"priceBadge\":\"$0 TODAY\",\"kicker\":\"Pro · $0 first 24 hours · then $9.99/month\",\"bonusPrimary\":\"1 trial production\",\"bonusSecondary\":\"2,500 credits/month after trial\"}", notes: "Centered Pro free-trial splash popup with upper-right close button. CTA goes directly to the verified monthly Pro trial checkout. The offer clearly states $0 for the first 24 hours, then $9.99/month unless cancelled through Whop." },
  { id: "campaign-promo", name: "Pro 24-hour free trial campaign", placement: "Home, categories and pricing top-right promo area", size: "320x220 countdown", width: 320, height: 220, status: "active", code: "{\"eyebrow\":\"24-HOUR FREE TRIAL\",\"title\":\"Start Crelavo Pro free\",\"body\":\"Make one trial production for $0, then continue with 2,500 credits at $9.99/month unless cancelled through Whop.\",\"cta\":\"Start free Pro trial\",\"href\":\"https://whop.com/checkout/plan_ujLQgM3kEg0dg\",\"durationDays\":7,\"storageKey\":\"crelavo-pro-2500-free-trial-countdown\",\"countdownLabel\":\"Trial offer ends in\",\"priceBadge\":\"$0 TODAY\",\"kicker\":\"Pro · then $9.99/month\",\"bonusPrimary\":\"1 trial production\",\"bonusSecondary\":\"2,500 credits/month after trial\"}", notes: "Admin can enable/disable/pause this Pro trial slot. CTA goes directly to the verified monthly Pro trial checkout." },
...
function shouldUpgradeLaunchCampaignSlot(slot: AdSlotConfig) {
  ...
  return !slot.code.trim()
    ...
    || (slot.id === "splash" && (signature.includes("team annual") || signature.includes("$1,300") || signature.includes("174,000") || signature.includes("team-annual-174000")));
}
