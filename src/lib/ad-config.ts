...
export const defaultAdSlots: AdSlotConfig[] = [
  ...
  { id: "splash", name: "Pro 24-hour free trial splash campaign", placement: "Home page visitor splash popup", size: "640x360 desktop, 320x250 mobile", width: 640, height: 360, status: "active", code: "{\"eyebrow\":\"PRO 24-HOUR FREE TRIAL\",\"title\":\"Try Crelavo Pro for $0 today\",\"body\":\"Card required. You are not charged until the 24-hour trial ends. Then $9.99 every 30 days unless you cancel in the customer portal. If you already used a Crelavo trial, you pay full price.\",\"cta\":\"Start free 24-hour trial\",\"href\":\"https://buy.polar.sh/polar_cl_Cm9e4bRp1FUCfYqQTzVSxq6w8jPVckCfb8VH21Z5ul7\",\"priceBadge\":\"$0 TODAY\",\"kicker\":\"Pro · $0 first 24 hours · then $9.99/month\",\"bonusPrimary\":\"1 trial production\",\"bonusSecondary\":\"Usage credits sold separately\"}", notes: "Centered Pro free-trial splash popup with the approved Polar monthly checkout and the paused annual option." },
  { id: "campaign-promo", name: "Pro 24-hour free trial campaign", placement: "Home, categories and pricing top-right promo area", size: "320x220 Pro trial card", width: 320, height: 220, status: "active", code: "{\"eyebrow\":\"24-HOUR FREE TRIAL\",\"title\":\"Start Crelavo Pro free\",\"body\":\"Try one production for $0, then continue with workspace access at $9.99/month unless cancelled in the customer portal. Usage credits are sold separately.\",\"cta\":\"Start free Pro trial\",\"href\":\"https://buy.polar.sh/polar_cl_Cm9e4bRp1FUCfYqQTzVSxq6w8jPVckCfb8VH21Z5ul7\",\"priceBadge\":\"$0 TODAY\",\"kicker\":\"Pro · then $9.99/month\",\"bonusPrimary\":\"1 trial production\",\"bonusSecondary\":\"Usage credits sold separately\"}", notes: "Admin can enable/disable/pause this Pro trial slot. CTA goes directly to the approved Polar monthly Pro trial checkout." },
