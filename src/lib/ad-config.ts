...
export const defaultAdSlots: AdSlotConfig[] = [
  ...
  { id: "splash", name: "Team Annual VIP Agency Bundle splash campaign", placement: "Home page visitor splash popup", size: "640x360 desktop, 320x250 mobile", width: 640, height: 360, status: "active", code: "{\"eyebrow\":\"LIMITED TIME ONLY: VIP AGENCY BUNDLE\",\"title\":\"Scale your e-commerce video production to the moon\",\"body\":\"Normally $1,560/yr, now $1,300/yr. Get 2 months FREE + 30,000 BONUS credits instantly added: 174,000 total annual credits for 300+ AI ad concepts, premium Shopify/Amazon video variations, bulk social campaigns or client-ready deliveries. Start with a secure $20 Whop 24-hour preview and cancel in Whop before the main plan starts if it is not the right fit.\",\"cta\":\"START 24-HOUR TEAM PREVIEW FOR $20\",\"href\":\"/dashboard/payment?package=team&billing=yearly&campaign=team-annual-174000\",\"durationDays\":7,\"storageKey\":\"crelavo-team-annual-174000-countdown\",\"countdownLabel\":\"VIP deal ends in\",\"priceBadge\":\"$1,300/yr\",\"kicker\":\"Normally $1,560/yr → now $1,300/yr + 30,000 BONUS credits\",\"bonusPrimary\":\"174,000 annual credits\",\"bonusSecondary\":\"$20 secure Whop preview\"}", notes: "Centered Team Annual splash popup with upper-right close button. Same browser sees it up to 3 times per day after 15 seconds or scroll. CTA goes to Team yearly checkout via secure Whop preview. Pricing/category promo slots remain on the $79 Business campaign." },
