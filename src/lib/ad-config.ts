...
export const defaultAdSlots: AdSlotConfig[] = [
  ...
  { id: "splash", name: "Team Annual VIP Agency Bundle splash campaign", placement: "Home page visitor splash popup", size: "640x360 desktop, 320x250 mobile", width: 640, height: 360, status: "active", code: "{\"eyebrow\":\"LIMITED TIME ONLY: VIP AGENCY BUNDLE\",\"title\":\"Scale your e-commerce video production to the moon\",\"body\":\"Stop wasting thousands on video editors or slow rendering tools. Generate around 300 AI product video drafts and variations for Shopify & Amazon, run 12 simultaneous tasks, and keep your 174,000 credits available across the active 12-month Team Annual period.\",\"cta\":\"START 24-HOUR TEAM PREVIEW FOR $20\",\"href\":\"/dashboard/payment?package=team&billing=yearly&campaign=team-annual-174000\",\"durationDays\":7,\"storageKey\":\"crelavo-team-annual-174000-countdown\",\"countdownLabel\":\"VIP deal ends in\",\"priceBadge\":\"$1,300/yr\",\"kicker\":\"Pay less, get 30,000 BONUS credits\",\"bonusPrimary\":\"174,000 credits today\",\"bonusSecondary\":\"Regular: 144,000\"}", notes: "Centered Team Annual splash popup with upper-right close button. Same browser sees it up to 3 times per day. CTA goes to Team yearly checkout. Pricing/category promo slots remain on the $79 Business campaign." },
