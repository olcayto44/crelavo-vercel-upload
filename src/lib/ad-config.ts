...
export const defaultAdSlots: AdSlotConfig[] = [
  ...
  { id: "splash", name: "Business 24-hour free trial splash campaign", placement: "Home page visitor splash popup", size: "640x360 desktop, 320x250 mobile", width: 640, height: 360, status: "active", code: "{\"eyebrow\":\"BUSINESS 24-HOUR FREE TRIAL\",\"title\":\"Try Crelavo Business for $0 today\",\"body\":\"Most AI platforms ask you to pay before you trust the workflow. Claim the first 24 hours free, then continue with the Business plan at $79/month unless cancelled through Whop. Business includes 12,000 AI production credits every month.\",\"cta\":\"CLAIM THE 24H FREE TRIAL\",\"href\":\"/dashboard/payment?package=business_24h_free_trial&billing=monthly&campaign=business-12000\",\"durationDays\":7,\"storageKey\":\"crelavo-business-12000-free-trial-countdown\",\"countdownLabel\":\"Trial offer ends in\",\"priceBadge\":\"$0 TODAY\",\"kicker\":\"Business · $0 first 24 hours · then $79/month\",\"bonusPrimary\":\"12,000 credits/month\",\"bonusSecondary\":\"24-hour free trial\"}", notes: "Centered Business free-trial splash popup with upper-right close button. Same browser sees it up to 3 times per day after 15 seconds or scroll. CTA goes to the Business monthly checkout via Whop. The offer clearly states $0 for the first 24 hours, then $79/month unless cancelled through Whop." },
