...
export const defaultAdSlots: AdSlotConfig[] = [
  ...
  { id: "splash", name: "$79 Business splash campaign", placement: "Home page visitor splash popup", size: "640x360 desktop, 320x250 mobile", width: 640, height: 360, status: "active", code: "{\"eyebrow\":\"LIMITED-TIME BUSINESS PREVIEW\",\"title\":\"Start your ecommerce video workflow for $10\",\"body\":\"Try Crelavo with a secure 24-hour preview, review the product-video workflow and continue only if the Business plan fits your team. The Business plan includes 12,000 AI production credits for ecommerce videos, ad assets and campaign workflows.\",\"cta\":\"START 24-HOUR BUSINESS PREVIEW FOR $10\",\"href\":\"/dashboard/payment?package=business&billing=monthly&campaign=business-12000\",\"durationDays\":7,\"storageKey\":\"crelavo-business-12000-countdown\",\"countdownLabel\":\"Offer ends in\",\"priceBadge\":\"$79/mo\",\"kicker\":\"12,000 annual credits · $10 secure preview\",\"bonusPrimary\":\"12,000 AI production credits\",\"bonusSecondary\":\"$10 secure preview\"}", notes: "Centered Business splash popup with upper-right close button. Same browser sees it up to 3 times per day after 15 seconds or scroll. CTA goes to Business monthly checkout via secure Whop preview. Team Annual remains available in the pricing flow." },
