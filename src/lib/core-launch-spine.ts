export const coreLaunchSpine = {
  ...
  components: [
    ...
    { key: "selected_media_providers", owner: "providers", check: "Selected video/image/voice/avatar/music providers have controlled live tests, polling and failure handling." },
  ...
  requiredEvidence: ["real_e2e_chain", "forced_failure_path", "provider_controlled_success", "credit_release_or_refund_path", "referral_reward_review", "coupon_whop_code_verification"],
