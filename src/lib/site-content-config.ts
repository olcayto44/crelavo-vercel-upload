...
export const localizedSeoNavLinks: PublicNavLink[] = [
  { label: "Home", href: "/", order: 1, active: true },
  { label: "Categories", href: "/categories", order: 2, active: true },
  { label: "Tools", href: "/tools", order: 3, active: true },
  { label: "Credits", href: "/pricing", order: 4, active: true },
...
export const defaultBlogTopics: BlogTopic[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "The intake is intentionally simple for launch. Customers can enter an address, use coordinate lookup, add route/path notes, choose camera movement and camera angle, then attach optional satellite images, route screenshots or location photos before production starts. That gives the production record a clearer location, route, landmark emphasis and visual sequence.",
      ...
      "The current implementation is safe for launch: users can provide address, coordinates, route details and reference files, while Crelavo keeps the output positioned as AI drone/satellite-style video rather than live physical drone footage.",
