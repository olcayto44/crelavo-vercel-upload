...
export const defaultBlogTopics: BlogTopic[] = [
  {
    ...
    linkedKeywords: [
      ...
      { label: "managed creative delivery", href: "/dashboard/productions" },
  ...
  },
  {
    ...
    body: [
      ...
      "For SEO and user clarity, this page describes the practical production intent directly: e-commerce campaign production, AI e-commerce campaign generator, marketplace listing assets, product link to ad video, product advertising video, product visual packages and managed creative delivery. These phrases match how sellers search when they want a product page converted into marketing assets rather than a blank prompt box.",
  ...
  },
  {
    ...
    kicker: "Managed creative delivery",
    title: "A managed workflow for credits, production status and final delivery",
    ...
    image: "/blog/managed-delivery-workflow.svg",
    imageAlt: "Managed creative delivery dashboard with credits and production status",
...
export const defaultFooterHelpPanels: FooterHelpPanel[] = [
  {
    ...
    items: [
      { title: "What can Crelavo produce?", body: "Websites, apps, e-commerce campaigns, AI videos, avatars, voice-over, visuals, brand kits, documents and managed delivery packages." },
