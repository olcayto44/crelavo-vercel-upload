  ...
  return <>
    ...
    <main className="public-home-page"><style id="clh-css" dangerouslySetInnerHTML={{ __html: css }} />
      ...
      <script dangerouslySetInnerHTML={{ __html: `console.log("CL HERO", ${JSON.stringify(activeHeroVideos.map((v) => v.id + "|" + v.heroEnabled + "|" + v.heroOrder + "|" + (v.videoUrl ?? "-")))});` }} /><section id="clh">
        <div className="stage"><div className="stage-bg" id="clh-hero-slides"><HeroVideoLoop /></div><div className="stage-veil" /><div className="stage-grain" /><div className="stage-copy"><div className="inner"><span id="clh-strip">Free member. No card.</span><h1>Make the feed look <em>expensive.</em></h1><p className="lede">Create a free Crelavo account. No card. After you are in, the 24h Pro preview is optional.</p><div className="cta-row"><a className="btn btn-cyan" href="/join">Create a free account</a></div></div></div></div>
