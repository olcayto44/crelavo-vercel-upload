...
import { HomeShowcaseGrid } from "@/components/home/HomeShowcaseGrid";
...
#clh .stage-bg video{position:absolute!important;inset:0!important;width:100%!important;height:100%!important;max-width:none!important;max-height:none!important;object-fit:cover!important;object-position:50% 50%!important}
...
@media(min-width:768px){html body #clh .stage-bg video{object-position:62% 50%!important}}
html body #clh .stage-bg video{position:absolute!important;inset:0!important;width:100%!important;height:100%!important;min-width:100%!important;min-height:100%!important;max-width:none!important;max-height:none!important;object-fit:cover!important;object-position:50% 50%!important;display:block!important}
...
export default async function HomePage() {
  const configuredShowcaseVideos = await getConfiguredShowcaseVideos({ includeDrafts: true });
  ...
  return <>
    ...
    <main className="public-home-page"><style id="clh-css" dangerouslySetInnerHTML={{ __html: css }} />
      ...
      <script dangerouslySetInnerHTML={{ __html: `console.log("CL HERO", ${JSON.stringify(activeHeroVideos.map((v) => v.id + "|" + v.heroEnabled + "|" + v.heroOrder + "|" + (v.videoUrl ?? "-")))});` }} /><section id="clh">
        ...
        <div className="wrap wall" id="clh-films"><span className="kicker">Showcase</span><h2>The work hits first. Copy comes second.</h2><p className="sub">Muted playback. Every film opens its full Crelavo example.</p><HomeShowcaseGrid films={films} /><a className="more" href="/showcase/explore-samples">Browse all {films.length} samples →</a></div>
