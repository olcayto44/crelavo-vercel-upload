...
const softwareApplicationJsonLd = {
  ...
  operatingSystem: "Web",
  offers: { "@type": "Offer", price: "9.99", priceCurrency: "USD", url: "https://buy.polar.sh/polar_cl_Cm9e4bRp1FUCfYqQTzVSxq6w8jPVckCfb8VH21Z5ul7" },
  ...
  return <>
    ...
    <main className="public-home-page"><style id="clh-css" dangerouslySetInnerHTML={{ __html: css }} />
      ...
      <section id="clh">
        ...
        <div className="wrap packs-head"><span className="kicker">Packages</span><h2>Four ways in. Prices match live checkout.</h2><div className="packs"><a className="pack intro" href="https://buy.polar.sh/polar_cl_Cm9e4bRp1FUCfYqQTzVSxq6w8jPVckCfb8VH21Z5ul7"><span>INTRO</span><strong>$9.99/mo</strong><p>24h preview, then $9.99. Card required. No charge until the preview ends.</p></a><a className="pack" href="/live-sales-credits"><span>Live Sales</span><strong>from $249/mo</strong><p>Starter 10 hours / 1 platform. Service hours, not credits.</p></a><a className="pack" href="/drone-credits"><span>Drone</span><strong>from $299</strong><p>Drone Location 2,600 credits one-time.</p></a><a className="pack" href="/growth-intelligence"><span>Growth</span><strong>from $179/mo</strong><p>Starter: 1 competitor, weekly PDF. Intelligence service.</p></a></div></div>
        <div className="final"><h2>24 hours to see the studio. Then $9.99/month unless you cancel.</h2><p>Card required. No charge until the preview ends. Annual checkout is temporarily unavailable while its Polar product is prepared.</p><div className="cta-row" style={{justifyContent:"center"}}><a className="btn btn-cyan" href="https://buy.polar.sh/polar_cl_Cm9e4bRp1FUCfYqQTzVSxq6w8jPVckCfb8VH21Z5ul7">Start 24-hour Pro preview — $9.99/mo</a><a className="btn btn-ghost" href="https://www.crelavo.com/checkout/unavailable">Annual Pro — $99/yr</a></div></div>
      </section>
      <div className="cl-sticky"><a className="pro" href="https://buy.polar.sh/polar_cl_Cm9e4bRp1FUCfYqQTzVSxq6w8jPVckCfb8VH21Z5ul7">Start Pro · $9.99/mo</a><a className="gin" href="/?auth=login">Sign in</a><a className="uye" href="/?auth=register">Üye ol</a><a className="cikis" href="#" role="button">Çıkış</a></div>
