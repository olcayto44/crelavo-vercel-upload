...
export default async function HomePage() {
  ...
  return <>
    ...
    <main className="public-home-page"><style id="clh-css" dangerouslySetInnerHTML={{ __html: css }} />
      ...
      <div className="cl-sticky"><a className="pro" href="/pricing#clp">Start Pro · $9.99/mo</a><a className="gin" href="/?auth=login">Sign in</a><a className="uye" href="/?auth=register">Üye ol</a><a className="cikis" href="#" role="button">Çıkış</a></div>
