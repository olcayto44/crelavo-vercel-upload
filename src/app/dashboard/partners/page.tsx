    ...
    <main className="container section dashboard-shell-layout dashboard-postlaunch-shell">
      ...
      <div id="clw">
        ...
        <div className="grid g3">
          ...
          <article className="card"><h3>Share INTRO</h3><p>24h preview, then $9.99/mo. Card required.</p><a className="ghost" href="https://buy.polar.sh/polar_cl_Cm9e4bRp1FUCfYqQTzVSxq6w8jPVckCfb8VH21Z5ul7">Pro checkout</a></article>
