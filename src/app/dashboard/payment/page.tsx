    ...
    <DashboardShell className="payment-dashboard-shell">
      ...
      <div className="payment-layout">
        <section className="card selected-billing-card payment-summary-card">
          ...
          {isServicePlan ? <p>{isGrowthService ? `This intelligence service plan renews ${billing === "yearly" ? "yearly" : "monthly"} until cancelled. Scraping, monitoring, report generation and alert limits follow the selected plan.` : `This live-agent service plan renews ${billing === "yearly" ? "yearly" : "monthly"} until cancelled. Extra live hours and provider/API usage are handled as pay-as-you-go after cost analysis.`}</p> : null}
