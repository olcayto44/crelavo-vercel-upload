  ...
  return (
    <DashboardShell>
      <section className="production-hero-card compact-production-hero">
        ...
        <div className="url-action-center"><Link className="btn" href="/dashboard/productions">Open productions</Link><Link className="btn secondary" href="/dashboard/ads">Open ads planning</Link></div>
      </section>
