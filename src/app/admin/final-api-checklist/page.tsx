    ...
    >
      ...
      <section className="card admin-wide-card" style={{ marginTop: 20 }}>
        ...
        <div className="admin-category-grid">
          ...
          <div className="card admin-category-card"><span className="badge">3 · {checklist.launchCompletionControls.publicSiteCleanupPlan.status}</span><h3>Public site temizliği</h3><p>{checklist.launchCompletionControls.publicSiteCleanupPlan.releaseGate}</p></div>
          <div className="card admin-category-card"><span className="badge">24 · {checklist.launchCompletionControls.postLaunchV2VisionPlan.status}</span><h3>Launch sonrası V2 vizyonu</h3><p>{checklist.launchCompletionControls.postLaunchV2VisionPlan.rule}</p></div>
          <div className="card admin-category-card"><span className="badge">23 · {checklist.launchCompletionControls.growthDataOptimizationPlan.status}</span><h3>SEO / sosyal veri optimizasyonu</h3><p>{checklist.launchCompletionControls.growthDataOptimizationPlan.nextAction}</p></div>
