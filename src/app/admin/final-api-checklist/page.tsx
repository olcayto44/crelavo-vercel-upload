  ...
  return (
    ...
    >
      ...
      <section className="card admin-wide-card" style={{ marginTop: 20 }}>
        ...
        <div className="admin-category-grid">
          <div className="card admin-category-card"><span className="badge">2 · {checklist.launchCompletionControls.realProductionE2EChecklist.status}</span><h3>Close real E2E gaps</h3><p>{checklist.launchCompletionControls.realProductionE2EChecklist.blockedStateRule}</p></div>
          <div className="card admin-category-card"><span className="badge">4 · {checklist.launchCompletionControls.referralRewardAutomationGuard.status}</span><h3>Referral automation</h3><p>{checklist.launchCompletionControls.referralRewardAutomationGuard.guardrail}</p></div>
          <div className="card admin-category-card"><span className="badge">5 · {checklist.launchCompletionControls.couponHuntCampaignGuard.status}</span><h3>Coupon hunt integration</h3><p>{checklist.launchCompletionControls.couponHuntCampaignGuard.checkoutGuard}</p></div>
          ...
          <div className="card admin-category-card"><span className="badge">3 · {checklist.launchCompletionControls.publicSiteCleanupPlan.status}</span><h3>Public site cleanup</h3><p>{checklist.launchCompletionControls.publicSiteCleanupPlan.releaseGate}</p></div>
          <div className="card admin-category-card"><span className="badge">24 · {checklist.launchCompletionControls.postLaunchV2VisionPlan.status}</span><h3>Post-launch V2 vision</h3><p>{checklist.launchCompletionControls.postLaunchV2VisionPlan.rule}</p></div>
          <div className="card admin-category-card"><span className="badge">23 · {checklist.launchCompletionControls.growthDataOptimizationPlan.status}</span><h3>SEO / social data optimization</h3><p>{checklist.launchCompletionControls.growthDataOptimizationPlan.nextAction}</p></div>
