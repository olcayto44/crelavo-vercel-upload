...
import { claimPreview } from "@/lib/billing-entitlements";
...
export async function POST(request: Request) {
  ...
  const safeProductionQuality = /1080p|premium/i.test(incomingQuality) ? "1080p" : "normal";
