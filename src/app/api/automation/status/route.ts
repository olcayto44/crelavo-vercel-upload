...
const qualityOutputCandidate = { ...outputWithRenderJob, visualStatus, renderStatus, finalVideoUrl: providerFinalUrl, providerFinalUrl, thumbnailUrl: heygenMeta.thumbnailUrl || heygenAgentBridge.thumbnailUrl || outputWithRenderJob.thumbnailUrl || undefined, posterUrl: heygenMeta.thumbnailUrl || heygenAgentBridge.thumbnailUrl || outputWithRenderJob.posterUrl || undefined, coverUrl: heygenMeta.thumbnailUrl || heygenAgentBridge.thumbnailUrl || outputWithRenderJob.coverUrl || undefined, captionedVideoUrl: heygenMeta.captionedVideoUrl || undefined, subtitleUrl: heygenMeta.subtitleUrl || outputWithRenderJob.subtitleUrl, heygenVideoPageUrl: heygenMeta.videoPageUrl || undefined, heygenAgentArtifacts: heygenAgentBridge.artifacts, latestHeyGenVideoArtifact: heygenAgentBridge.latestVideoArtifact, heygenLatestVideoResourceId: heygenAgentBridge.latestVideoResourceId || outputWithRenderJob.heygenVideoId, providerStatus: `${successfulStatus.provider}_succeeded`, creativeActivityLog: completedCreativeActivityLog, alternatives: polledAlternatives, alternativeStatuses };
      ...
      try {
       ...
       const finalOutput: Record<string, any> = outputWithWorkflow(finalProductionState, outputWithRenderJob, {
         visualStatus,
         renderStatus,
         finalVideoUrl: finalUrl,
         providerFinalUrl,
         thumbnailUrl: heygenMeta.thumbnailUrl || heygenAgentBridge.thumbnailUrl || outputWithRenderJob.thumbnailUrl || undefined,
         posterUrl: heygenMeta.thumbnailUrl || heygenAgentBridge.thumbnailUrl || outputWithRenderJob.posterUrl || undefined,
         coverUrl: heygenMeta.thumbnailUrl || heygenAgentBridge.thumbnailUrl || outputWithRenderJob.coverUrl || undefined,
         captionedVideoUrl: heygenMeta.captionedVideoUrl || undefined,
         subtitleUrl: heygenMeta.subtitleUrl || outputWithRenderJob.subtitleUrl,
         heygenVideoPageUrl: heygenMeta.videoPageUrl || undefined,
         heygenAgentArtifacts: heygenAgentBridge.artifacts,
         latestHeyGenVideoArtifact: heygenAgentBridge.latestVideoArtifact,
         heygenLatestVideoResourceId: heygenAgentBridge.latestVideoResourceId || outputWithRenderJob.heygenVideoId,
         finalAssetMirror,
         alternatives: updatedAlternatives,
         alternativeStatuses: polledAlternatives.length ? alternativeStatuses : [],
         providerStatus: `${successfulStatus.provider}_succeeded`,
         creativeActivityLog: completedCreativeActivityLog,
         providerLifecycle: { visual: visualLifecycle, render: renderLifecycle },
         readyGate: effectiveReadyGate,
         qualityGate: { status: "passed", checkedAt: new Date().toISOString(), required: effectiveReadyGate.required, missing: [], warnings: effectiveReadyGate.warnings },
         creditResolution,
         finalizedReservedCredits
       });
       finalOutput.outputRegistry = buildOutputRegistry({ ...finalProductionState, output_json: finalOutput });
       finalOutput.workflowState = buildProductionWorkflowState({ ...finalProductionState, output_json: finalOutput });
