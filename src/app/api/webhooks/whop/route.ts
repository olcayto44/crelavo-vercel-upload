...
function expectedProductAmountUsd(product: Product, billing: string) {
  if (product.planType === "subscription" || product.planType === "service_subscription") {
    return billing === "yearly" && "yearlyPriceUsd" in product && typeof product.yearlyPriceUsd === "number" ? product.yearlyPriceUsd : billing === "yearly" ? product.priceUsd * 10 : product.priceUsd;
  }
