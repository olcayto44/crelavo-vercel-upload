  ...
  return (
    <main className="container legal-page clean-feed-section">
      ...
      <section className="card legal-content-card">
        ...
        <p>Some Crelavo services use credits. Monthly or yearly subscriptions may start with a paid 24-hour preview, including a non-refundable setup fee, one 10-second watermarked preview video and downloads closed until the selected subscription begins. Monthly or yearly subscriptions renew automatically through the payment provider until cancelled. Unused monthly subscription credits roll over only while the subscription remains active and renewal succeeds, with a maximum rollover-protected balance based on the package allowance. If a subscription is cancelled or deactivated, subscription credits and rolled-over subscription credits may expire at the end of the active billing period or when access ends. Annual subscription credits remain available during the active annual subscription period. One-time top-up packages and one-time production packages do not renew automatically; top-up credits are tracked separately. Credits may be reserved when production begins, and package details shown at checkout or in the dashboard control what is included.</p>
