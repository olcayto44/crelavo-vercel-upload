...
html body:not(:has(header.site-main-nav)):not(:has(main.dashboard-shell-layout)):not(:has(main.omni-work-route)){padding-top:56px}
html body:not(:has(header.site-main-nav)):not(:has(main.dashboard-shell-layout)):not(:has(main.omni-work-route)) .cl-fallback-bar{display:flex!important;position:fixed!important;top:0!important;left:0!important;right:0!important;z-index:80!important;align-items:center!important;height:56px!important;padding:0 88px 0 16px!important;background:#070b18!important;border-bottom:1px solid rgba(255,255,255,.08)!important;font:700 15px/1 Inter,system-ui,sans-serif!important}
.cl-fallback-bar a{color:#f8fbff!important;text-decoration:none!important}
...
export function InnerMobileNav() {
  ...
  return <>
    ...
    <div id="cl-inner-nav">
      <div className="cl-fallback-bar"><a href="/">Crelavo</a></div>
