...
const providerTests = [
  ...
  { id: "meta", label: "Meta" },
  { id: "whop", label: "Whop webhook" },
  { id: "indexnow", label: "Bing IndexNow" },
  { id: "tiktok", label: "TikTok OAuth" },
  { id: "youtube", label: "YouTube OAuth" },
...
export function AdminProviderTestPanel() {
  ...
  return (
    <section className="card admin-wide-card" style={{ marginTop: 20 }}>
      ...
      <h2>Run controlled API checks from admin</h2>
