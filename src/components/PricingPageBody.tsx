...
.clp-intro{margin:0 0 22px;padding:28px 24px;border-radius:24px;border:1px solid rgba(34,211,238,.45);background:linear-gradient(180deg,rgba(14,165,233,.16),rgba(2,6,23,.94))}
.clp-intro .clp-price b{font-size:48px;color:#22d3ee}
.clp-intro .clp-cta{margin-top:8px;max-width:280px}
    `}</style>
