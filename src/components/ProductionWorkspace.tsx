...
const [notice, setNotice] = useState("");
  ...
  const rawPreviewUrl = safeAssetUrl(production.preview_url || outputJson.previewUrl || outputJson.preview_url);
  const rawDeliveryUrl = safeAssetUrl(production.delivery_zip_url || production.delivery_link || outputJson.deliveryZipUrl || outputJson.delivery_url);
